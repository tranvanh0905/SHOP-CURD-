                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        <a href="<?= $baseUrl ."admin/them-tai-khoan"; ?>"><button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        ...
                                                        <a href="<?= $baseUrl ."admin/sua-tai-khoan?id=" .$item->id ?>"><button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                            <i class="zmdi zmdi-edit"></i>
                                                        </button></a>
                                                        <a linkUrl="<?php echo $baseUrl ."removeUser?id=" .$item->id ?>" onclick="removeProduct(this)" href="javascript:;" ><button   class="item" data-toggle="tooltip" data-placement="top" title="Delete">
