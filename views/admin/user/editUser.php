            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    ...
                    <div class="card">
                                    ...
                                    <form action="<?= $baseUrl ."updateUserAdmin" ?>" id="addForm" method="post" class="" novalidate>
                                    ...
                                    <input type="hidden" name="id" value="<?php echo $model->id; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"  name="email" value="<?php echo $model->email ?>" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label class=" form-control-label">Quyền :</label>
                                                <select
                                                 name="role" class="form-control">
                                                    <option <?php if($model->role == 0): ?> selected<?php endif; ?> value="0">Người dùng</option>
                                                    <option <?php if($model->role == 1): ?> selected<?php endif; ?> value="1">Admin</option>
                                                </select>
                                            </div>
