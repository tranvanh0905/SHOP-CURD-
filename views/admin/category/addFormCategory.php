            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    ...
                    <div class="card">
                                    ...
                                    <form action="<?= $baseUrl ."addCategory" ?>" id="addCategoryForm" method="post" class="" novalidate>
                                    <div class="card-body card-block">
                                            <div class="form-group">
                                                <label class=" form-control-label">Tên danh mục :</label>
                                                <input type="text" id="nf-email" name="cate_name" class="form-control">
                                            </div>
            ...
            $('#addCategoryForm').validate({
                ...
                messages:{
                    cate_name: {
						...
						regex: "* Danh mục không được chứa ký tự đặc biệt",
                    }
                }
            });
        })
