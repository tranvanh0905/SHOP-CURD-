                ...
                <div class="section__content section__content--p30">
                    ...
                    <div class="card">
                                    <div class="card-header">
                                        <strong>CẬP NHẬT</strong> DANH MỤC
                                    </div>
                                    <form action="<?= $baseUrl ."updateCategory" ?>" id="updateCategoryForm" method="post" class="" novalidate>
                                    <div class="card-body card-block">
                                            <div class="form-group">
                                                <input type="hidden" name="id" value="<?= $model->id; ?>">
                                                <label class=" form-control-label">Tên danh mục :</label>
                                                <input value="<?= $model->cate_name; ?>" type="text" id="nf-email" name="cate_name" class="form-control">
            ...
            $('#updateCategoryForm').validate({
                ...
                messages:{
                    cate_name: {
                        ...
                        maxlength: "* Danh mục phải ít hơn 50 ký tự",
                    }
                }
            });
        })
