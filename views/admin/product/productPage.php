                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        <a href="<?= $baseUrl ."admin/them-san-pham"; ?>"><button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            ...
                                            <tr class="tr-shadow" style="text-align:center;">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        ...
                                                        <a href="<?= $baseUrl ."admin/sua-san-pham?id=" .$item->id ?>"><button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
