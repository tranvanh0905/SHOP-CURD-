            ...
            <!-- FORM ADD PRODUCT -->
                                    ...
                                    <div class="card-body card-block">
                                            ...
                                            <input type="hidden" name="id" value="<?= $model->id; ?>">
                                                ...
                                                <input type="text" value="<?= $model->name; ?>" id="nf-email" name="name" class="form-control">
                                                <br>
                                                ...
                                                <br>
                                                <?php  ?>
                                                <img src="../<?= $model->image?>" width="250" id="blah" >
                                                <br>
                                                <br>
                                                <label class=" form-control-label">Danh mục sản phẩm :</label>
                                                <select name="cate_id" class="form-control">
                                                    <?php foreach($category as $item): ?>
                                                    <option <?php if($model->cate_id == $item->id): ?>
                                                    selected
                                                    <?php endif; ?>
                                                    value="<?= $item->id ?>"><?= $item->cate_name ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                                <br>
                                                ...
                                                <div id="boxCheckBox">
                                                <?php $sizeCut = explode(',',$model->size);
                                                for($i = 0; $i<count($sizeCut); $i++){
                                                ?>
                                                <span><?= $sizeCut[$i] ?></span> <input <?php if(isset($sizeCut[$i])): ?> checked <?php endif; ?> class="inputCheckbox" type="checkbox" name="size[]" value="<?= $sizeCut[$i] ?>">
                                                <?php }; ?>
                                                ...
                                                ?>
                                                <span><?= $colorCut[$i] ?></span> <input <?php if(isset($colorCut[$i])): ?> checked <?php endif; ?> class="inputCheckbox2" type="checkbox" name="color[]" value="<?= $colorCut[$i] ?>">
                                                <?php }; ?>
