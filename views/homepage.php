...
<body class="animsition">
				...
				<ul class="header-cart-wrapitem w-full">
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="style/images/item-cart-01.jpg" alt="IMG">
						</div>
	...
	<section class="bg0 p-t-23 p-b-140">
		<div class="container" >
			<div class="p-b-10">
				<h3 class="ltext-103 cl5" style="font-family: 'Noto Serif', serif;" >
					SẢN PHẨM MỚI NHẤT
				</h3>
			</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<a><img height="334" src="<?= $item->image ?>" alt="IMG-PRODUCT"></a>
							<a href="#" style="	font-family: 'Noto Serif', serif;font-weight:bold;" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
								Thêm vào giỏ
							</a>
						</div>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" style="font-family: 'Noto Serif', serif;font-size:18px;" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									<?= $item->name ?>
								</a>
