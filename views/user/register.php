			...
			<div class="top-bar">
				...
				<?php if($user == null): ?>
					 <div class="right-top-bar flex-w h-full">
						<a href="<?= $baseUrl ."dang-nhap-tai-khoan"; ?>" class="flex-c-m trans-04 p-lr-25">
							Đăng nhập tài khoản
						</a>
						<a href="<?= $baseUrl ."dang-ky-tai-khoan"; ?>" class="flex-c-m trans-04 p-lr-25">
							Đăng ký tài khoản
						</a>
					</div>
				<?php endif; ?> 
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">		
						<!-- <li>
								<a href="<?= $baseUrl ."dang-nhap-tai-khoan" ?>" id="loginTagA">Đăng nhập tài khoản</a>
						</li> -->
						<?php if($user != null): ?>
						<ul class="main-menu">
						<li class="">
									<a href="index.html"><span style="font-size:12px;">Tài khoản : </span> <span style="font-size:20px;text-transform:upperCase;"><?= $user['name'] ?><span></a>
									<ul class="sub-menu">
										<li><a href="#">Thông tin cá nhân</a></li>
										<li><a href="#">Thay đổi mật khẩu</a></li>
										<?php if($user['role']==1): ?>
										<li><a href="<?= $baseUrl ."admin"; ?>">Vào trang quản lý</a></li>
										<?php endif; ?>
						...
						<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti" data-notify="0">
							<a href="shoping-cart.html" style="color:#222;"><i class="zmdi zmdi-shopping-cart"></i></a>
						</div>
		...
		<div class="container">
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form method="POST" id="registerForm" action="<?= $baseUrl ."add-User" ?>" novalidate>
                        ...
                        <div class="bor8 m-b-20 how-pos4-parent">       
                                <i class="fas fa-key how-pos4 pointer-none"></i>
                                <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" id="password_Check" type="password" name="password" placeholder="Mật khẩu tài khoản" >
                        </div>
						<label for="password_Check" id="regEx_rePassword" generated="true" class="error"></label>
                        <label>Xác nhận mật khẩu : </label>
                        <div class="bor8 m-b-20 how-pos4-parent">       
                                <i class="fas fa-key how-pos4 pointer-none"></i>
                                <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="password" id="re_Password" name="rePassword" placeholder="Mật khẩu tài khoản" >
                        </div>  
						<label for="re_Password" generated="true" class="error"></label>
                        <label>Email : </label>
                        <div class="bor8 m-b-20 how-pos4-parent">       
                                <i class="fas fa-envelope how-pos4 pointer-none"></i>
                                <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="email" id="checkEmailInput" placeholder="Email sử dụng" >
                        </div>
						<label for="checkEmailInput" generated="true" class="error"></label>
						<span style="color: red"><?php
...
<!--===============================================================================================-->
	...
	// 		var emailCheck = $("#checkEmailInput").val();
	// 		$.ajax({
	// 			url: "add-User",
	// 			type:"POST",
	...
	// 				$(".emailListCheck").before(result);
	// 				return false;
	// 			}
	// 		});
	// 		$("#checkEmailInput").val(emailCheck);
	// 			return false;
	// 	});
	// });
	</script>
